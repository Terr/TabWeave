    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sOldUsername = new String(mTabWeavePrefs.getString(TabWeave.PREFS_USERNAME, "").toCharArray());
                String sOldPassword = new String(mTabWeavePrefs.getString(TabWeave.PREFS_PASSWORD, "").toCharArray());
                String sOldPassphrase = new String(mTabWeavePrefs.getString(TabWeave.PREFS_PASSPHRASE, "").toCharArray());
